...
order by height. Let this ordering be represented by the integer array expected where expected[i] is the expected height of the ith student in line.
You are given an integer array heights representing the current order that the students are standing in. Each heights[i] is the height of 
...
for index, number in enumerate(heights):
    if number != output[index]:
        result += 1
return result
If you like this explanation, please consider giving it a star on my github.
