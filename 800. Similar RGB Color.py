...
Since we only need to find the closest colors with shorthand, we can list out all shorthand hex codes 
and find out the closest hex code combination to the given color.
